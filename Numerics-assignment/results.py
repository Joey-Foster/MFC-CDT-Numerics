...
#Figure 1
produceStaticPlot(h0, h_lims = [0.9,2], u_lims = [-1,1], U0=U0, nx=nx, g=g, t_end=t_end, 
...
#Figure 2
produceStaticPlot(h0, h_lims = [0,1], u_lims = [-3,3], U0=U0, nx=nx, g=g, t_end=t_end, 
...
#Figure 3
produceStaticPlot(h0, h_lims = [0.9,2], u_lims = [3.5,6.5], U0=U0, nx=nx, g=g, t_end=t_end, 
...
# produceStaticPlot(h0, h_lims = [0.9,2], u_lims = [-1,1], nx = nx, g = g, H = H, t_end = t_end, 
